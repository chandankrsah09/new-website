  ...
  return (
    <div className="bannerFullWidth_wrapper relative bg-gradient-to-r from-blue-50 to-blue-100" style={{ width: '754.4px', height: '172px', maxWidth: '100%' }}>
      <div className="bannerFullWidth_container relative">
        ...
        <div className="bannerFullWidth_content">
          <div className="flex items-center justify-between h-full">
            <div className="flex-1">
              <h1 className="bannerFullWidth_title" style={{ color: '#2d2d2d' }}>
                <span style={{ display: 'inline' }}>
                  <span>Best Weight Loss Injections of 2025</span>
                </span>
              </h1>
              
              <p className="text-sm mb-2 leading-relaxed" style={{ color: '#2d2d2d' }}>
              ...
              <div className="bannerFullWidth_last-update-text flex items-center">
                <span style={{ color: '#2d2d2d' }} className="flex items-center text-sm">
                  <svg 
                    stroke="currentColor" 
                    fill="currentColor" 
                    strokeWidth="0" 
